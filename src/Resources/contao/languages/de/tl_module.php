 ...
 * Fields
 */
$arrLang['iso_description']                                  = ['Beschreibung', 'Geben Sie hier eine Beschreibung des Moduls ein.'];
$arrLang['addSlick']                                         = ['Slick-Slider verwenden', 'Wählen Sie diese Option, um die Produktliste als Slick-Slider anzuzeigen.'];
...
$arrLang['iso_direct_checkout_product_mode']                 = ['Produktmodus', 'Wählen Sie aus, ob ein bestimmtes Produkt oder ein Produkt eines speziellen Produkttyps auswählbar sein soll.'];
$arrLang['iso_direct_checkout_product_mode']['product']      = 'Produkt';
$arrLang['iso_direct_checkout_product_mode']['product_type'] = 'Produkttyp';
$arrLang['iso_direct_checkout_products']                     = ['Produkte', 'Wählen Sie die Produkte aus, die über die Direktbestellung bestellt werden können.'];
$arrLang['iso_direct_checkout_product']                      = ['Produkt', 'Wählen Sie ein Produkt aus, das über die Direktbestellung bestellt werden kann.'];
...
$arrLang['iso_direct_checkout_product_type']                 = ['Produkttyp', 'Wählen Sie den Produkttypen aus, dem ein Produkt zugeordnet sein muss, um über die Direktbestellung bestellt werden zu können.'];
$arrLang['iso_direct_checkout_listingSortField']             = ['Auswahlfeld', 'Wählen Sie hier aus, welches Feld zur Auswahl eines Produkt aus des gewählten Produkttyps'];
$arrLang['iso_direct_checkout_listingSortDirection']         = ['Sortierrichtung', 'Wählen Sie Sortierrichtung aus, die für das Auswahlfeld gilt.'];
$arrLang['iso_price_filter']                                 = ['Produktpreisfilter', 'Wählen Sie eine Option aus, um eine Filterung bzgl. des Produktpreises zu aktivieren.'];
$arrLang['iso_price_filter']['paid']                         = 'Nur kostenpflichtig';
$arrLang['iso_price_filter']['free']                         = 'Nur kostenlos';
$arrLang['iso_producttype_filter']                           = ['Produkttypfilter', 'Wählen Sie eine Option aus, um eine Filterung bzgl. des Produkttyps zu aktivieren.'];
$arrLang['iso_use_notes']                                    = ['Bemerkungsfeld hinzufügen', 'Wählen Sie eine Option aus, um dem Bestellformular ein Bemerkungsfeld hinzuzufügen.'];
$arrLang['iso_note']                                         = ['Bemerkungen', ''];
$arrLang['iso_editableCategories']                           = ['Produkttyp', 'Wählen Sie hier den Produkttypen aus, der dem erstellten Produkt zugewiesen wird.'];
$arrLang['iso_productCategory']                              = ['Kategorien', 'Wählen Sie hier die Kategorien aus, der dem erstellten Produkt zugewiesen werden.'];
