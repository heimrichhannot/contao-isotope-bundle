...
$GLOBALS['TL_DCA']['tl_iso_product_data'] = [
    ...
    'fields'   => [
        ...
        'initialStock'            => [
            ...
            'load_callback' => [['HeimrichHannot\IsotopeBundle\Backend\Callbacks', 'overwriteInitialStockWithProductData']],
        ],
        'stock'                   => [
            ...
            'sql'           => "varchar(255) NOT NULL default ''",
            'load_callback' => [['HeimrichHannot\IsotopeBundle\Backend\Callbacks', 'overwriteStockWithProductData']],
        ],
        'setQuantity'             => [
            ...
            'attributes'    => ['legend' => 'inventory_legend', 'fe_sorting' => true],
            'sql'           => "varchar(255) NOT NULL default ''",
            'load_callback' => [['HeimrichHannot\IsotopeBundle\Backend\Callbacks', 'overwriteQuantityWithProductData']],
        ],
        'releaseDate'             => [
